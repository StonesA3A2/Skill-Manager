        ...
        <section className="space-y-2">
          {repoWarnings.length > 0 && (
            <div className="app-panel flex flex-wrap items-start gap-2 p-3 border border-amber-500/40 bg-amber-500/10">
              ...
              {repoWarnings.includes("migration_incomplete") && (
                <button
                  type="button"
                  onClick={() => {
                    api.restartApp().catch((err) => {
                  ...
                  className={`${actionButtonClass} shrink-0 border-amber-500/40 bg-amber-500/10 text-amber-800 hover:bg-amber-500/20 dark:text-amber-300`}
                >
